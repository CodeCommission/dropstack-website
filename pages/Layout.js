    ...
    return (
      <LayoutContainer>
        ...
        <ScrollToTop href="#"><i className="fa fa-angle-up"></i></ScrollToTop>
          <NavItems>
            <NavItem>
              <NavLink href="https://codecommission.com" target="_blank" rel="noopener">©2017 dropstack.run · CodeCommission ·</NavLink>
              <br />
            ...
            <NavItem><NavLink href={'https://github.com/codecommission/dropstack-cli'}>GitHub</NavLink></NavItem>
          </NavItems>
        </Footer>
      </LayoutContainer>
    )
