              ...
              <div className="wow fadeInLeft animated" data-wow-delay="0.3s">
                <AboutInfoContainer>
                  ...
                  <AboutInfo>
                    ...
                    <p>Install the dropstack-cli and just enter <strong>dropstack deploy</strong> - your deployment is ready to use. You don't need servers, repositories, accounts or different configurations.</p>
                  </AboutInfo>
                </AboutInfoContainer>
              </div>
